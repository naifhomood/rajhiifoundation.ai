...
analyzeButton.addEventListener('click', async () => {
  ...
  try {
    ...
    const defaultInstructions = 'قم بتحليل المشاريع المقدمة وفقاً للمعايير والقيم الأساسية لمؤسسة عبدالله بن عبدالعزيز الراجحي الخيرية. المؤسسة هي جهة أهلية مانحة تهدف إلى خدمة المجتمع من خلال دعم وتمويل المشاريع التنموية المقدمة من المنظمات غير الربحية.ركز التحليل على تقديم توصيات عملية ومحددة تُسهم في تحسين المشروع ليتماشى مع القيم التالية: العمل التشاركي الاستدامة الريادة الابتكار والاحترافية في حال نقص المعلومات المطلوبة في المشروع، قدّم توصيات لسد هذه الفجوات وتعزيز توافق المشروع مع أهداف المؤسسة الخيرية';
